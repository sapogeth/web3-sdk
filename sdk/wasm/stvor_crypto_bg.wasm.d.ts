...
export const __wbg_wasmaaidentity_free: (a: number, b: number) => void;
export const __wbg_wasmkeypair_free: (a: number, b: number) => void;
export const __wbg_wasmsession_free: (a: number, b: number) => void;
export const wasm_aa_bind_userop: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
export const wasm_aa_derive: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number, number];
export const wasm_aa_sign_ton_extension: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
export const wasm_aa_verify_ton_extension: (a: number, b: number, c: number, d: number) => [number, number, number];
export const wasm_aa_verify_userop: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number];
...
export const wasmaaidentity_address: (a: number) => [number, number];
export const wasmaaidentity_chain_type: (a: number) => [number, number];
export const wasmaaidentity_derive: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number];
export const wasmaaidentity_establish_session_with: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number, number];
export const wasmaaidentity_identity_key: (a: number) => [number, number];
export const wasmaaidentity_mlkem_ek: (a: number) => [number, number];
export const wasmaaidentity_respond_to_session: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number];
export const wasmaaidentity_signed_pre_key: (a: number) => [number, number];
export const wasmaaidentity_spk_signature: (a: number) => [number, number];
export const wasmaaidentity_verify_spk: (a: number) => [number, number, number];
